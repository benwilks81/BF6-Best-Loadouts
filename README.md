...
You can double-click `index.html` — it works offline via embedded data.

Optional local server on **5175** (Node is not installed on this host; use Python):
...
- Browser never talks to GitHub — only the refresh timer/script does.
